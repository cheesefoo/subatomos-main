...
<style lang='scss'>
  ...
  .box-inner-border {
    ...
    &.yellow {
      ...
      background-image: url('/assets/images/namebanner.webp'), url(/assets/images/Star_bg_yellow.png);
    ...
    &.pink {
      ...
      background-image: url('/assets/images/namebanner.webp'), url(/assets/images/Star_bg_pink.png);
      background-position: 0 20px, right top;
      background-size: 100% 2.5em, 40% auto;
    }
  }
