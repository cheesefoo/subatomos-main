...
<script>
	...
	import metaimg from '/src/assets/images/subaru_birthday_thumbnail.png';
	import metatwi from '/src/assets/images/subaru_birthday_thumbnail.jpg';

	import piano from '/src/assets/images/instruments/piano.webp';
	import accordion from '/src/assets/images/instruments/accordion.webp';
	import flute from '/src/assets/images/instruments/flute.webp';
	import drums from '/src/assets/images/instruments/drums.webp';
	import guitar from '/src/assets/images/instruments/guitar.webp';
	import saxophone from '/src/assets/images/instruments/saxophone.webp';
	import showMapIcon from '/src/assets/images/subatomos_around_world.png';
	import loading from '/src/assets/images/instruments/loading-suba-music.gif';
...
<style lang='scss'>
  ...
  .show-map {
    ...
    flex-direction: column;
    text-align: center;
    background-image: url(/src/assets/images/instruments/stand_pole.png);
  ...
  .top {
    ...
    background: #c7c2b6 url(/src/assets/images/instruments/music_sheet_bg.png) no-repeat 0 20vh;
    background-size: 100%;
    display: flex;
    flex-wrap: wrap;
    justify-content: space-around;
  ...
  .top-color-picker {
    ...
    background: #2B4162 url(/src/assets/images/instruments/music_sheet_bg_border.webp) no-repeat 0 20vh;
  ...
  .video-container {
    ...
    align-items: center;
    background-image: url(/src/assets/images/instruments/stand.webp) !important;
  ...
  @media screen and (max-width: 849px) {
    ...
    .show-map {
      ...
      align-items: center;
      background-image: url(/src/assets/images/instruments/stand_pole_mobile.png);
      background-repeat: no-repeat;
      background-size: 100% auto;
      bottom: 0;
      display: flex;
    ...
    .video-container {
      align-content: center;
      align-items: center;
      background-image: url(/src/assets/images/instruments/stand_mobile.png) !important;
      background-position: bottom center;
      background-repeat: no-repeat;
      background-size: contain;
      display: block;
