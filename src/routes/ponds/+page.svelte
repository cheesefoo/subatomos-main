...
<svelte:head>
	<title>Subatomo Ponds</title>

	<meta name="description" content="A website by overseas fans showcasing community projects celebrating Oozora Subaru" />
</svelte:head>
<main>
	<h1>Subatomo Ponds</h1>
	<h3>1 million subscribers & birthday project</h3>
