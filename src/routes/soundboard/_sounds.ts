...
const sounds: Array<SubaSound> = [
	...
	{ name: '(ASMR)Ahhhh', category: 'ASMR', file: 'ASMR_Ahhhh.mp3' },
	{ name: '(ASMR)yabai crowing', category: 'ASMR', file: 'ASMR_yabai_crow_sound.mp3' },
	{ name: '(ASMR)yabai dying ', category: 'ASMR', file: 'ASMR_yabai_dying_sounds.mp3' },
	{ name: 'Happy New Year', category: 'ASMR', file: 'asmr_akeome' },
	...
	{ name: 'i am not donald duck anymore 📱', file: 'iamnotdonaldduckanymore.mp3' },
