const messages = [
	...
	},
	{
		name: 'メイム',
		message:
			'スバルちゃん3周年おめでとう！！これからも唯一無二のアイドル目指して駆け上がっていけ！！'
	},
	{
		name: 'トリガーハッピー',
		message:
			'３年目突入おめでとういえーーーい！！これからも無病息災で末永く活動されることを、全力で推しながらお祈りしてるゾイ！！そんでこれからもよろすくな！！！'
	},
	{
		name: 'Bumi',
		message:
	...
	},
	{
		...
		message: '３シュウネンオメデトウナンダヨ！４ネンメノスバルチャンノカツヤクモタノシミナンダヨ！'
	},
	{
		name: 'M.R. 4',
		message:
	...
	},
	{
		name: '稚魚らいか',
		message:
			'すばるちゃんの素直でサービス精神旺盛な配信でいつも元気にしてもらってます。これからも地獄企画とか良い叫び声のホラーゲーム配信とか続けていってください！３周年本当におめでとうございます！'
	},
	{
		name: 'SpiderNevi',
		message:
	...
	},
	{
		name: 'タカ',
		message:
			'スバル、３周年おめでとう これからも応援していくよ！ スバルの声聞いてると、元気が出てくるんだよ！ ありがとう、スバル'
	},
	{
		name: 'Dalton ',
		message:
	...
	},
	{
		name: 'NeoB.',
		message:
			'スバルちゃん３周年おめでとうううう！！たくさんの人（海外も日本も）を幸せにしてくれて本当にありがとうう！！これからも頑張るね～'
	},
	{
		name: '雷光',
		message:
			'３周年おめでとうございます！ スバルに出会って初めて“推し”という存在が出来て、人生が明るくなりました！ 自分に出来ることは微々たるものですが、これからも応援していきます！'
	},
	{
		name: '@_Tommy_103',
		message:
			'スバルちゃん3周年おめでとう！！！もうすぐ4年目！もう大先輩じゃん！ｗスバルちゃんのおかげで沢山の出会いがあったし，たくさんの刺激をうけた！本当に感謝だよ！これからもずっとずっとよろしくね！4年目も活動楽しみにしてるね～'
	},
	{
		name: 'Ly (@HeyKDHR)',
		message:
	...
	},
	{
		name: '丘ナパキ',
		message:
			'スバルちゃん！3周年おめでとう！！！もう丸2年以上応援していると思うと感慨深いです。スバルちゃんの配信でもらえる笑顔で日々の仕事を頑張れています！本当にありがとう！これからもスバルちゃんがのびのび活動できるように微力ながら応援していきます。大好きだぞ！！！'
	},
	{
		name: 'X',
		message:
	...
	},
	{
		name: 'カズりん',
		message:
			'去年の暮からホロライブにハマってある日スバルちゃんの配信を観てから一気にスバルちゃんにハマってずっと応援してます！ スバルちゃんの楽しそうにゲームやってる姿と喋ってるときと歌ってるときのギャップに惚れました！！ これからも４周年に向けて喉改めお身体に気をつけて配信頑張ってくださいね！！！'
	},
	{
		name: 'ChloeKurosu',
		message:
	...
	{ name: '@SacredsunTV', message: '三周年記おめでとう！いつも楽しい時間ありがおつ！' },
	{
		name: 'Aishアイシ',
		message:
	...
	},
	{
		name: 'くろまめ',
		message:
			'スバルちゃん3周年おめでとう！自分はスバルちゃんを知って5ヶ月だけだけど本当に毎日が楽しいです！あなたがいなければ今の元気な僕はいないです。本当に生きる理由になっています。ありがとう。これからもずっと応援しています。'
	},
	{
		name: '@_Jenos_',
		message:
	...
	{ name: '@gurekoro', message: '忙しい日もほぼ毎日楽しい動画を作ってくれてありがとう…' },
	{
		name: 'PoPoLoco',
		message:
	...
	},
	{
		name: '@superakiraman',
		message:
			'3周年おめでとう！いつも頑張ってるスバルちゃんに元気をもらってます。これからも応援してるよ！'
	},
	{
		name: 'Virel',
		message:
	...
	{ name: 'なっと', message: '3周年おめでとうございます！' },
	{
		name: '@amnotred',
		message:
	...
	},
	{
		name: 'reece',
		message:
			'スバルちゃん3周年おめでとう！この3年間のスバルちゃんの躍進はほんとに凄かった！4年目もスバルちゃんの活躍を楽しみにしてます！'
	},
	{
		name: 'hiro',
		message:
			'スバルちゃん3周年おめでとう！いつもゲームに企画に歌にいっぱい元気をありがとう！4年目もやりたい事を笑顔でやっていってね！無難なことしか言えないけどいつも応援してるよ！'
	},
	{
		name: 'Jesse',
		message:
	...
	{ name: 'すとねく', message: '3周年おめでとう！4年目もよろしく！' },
	{
		name: '蔡宇安 @a1r2t3i4e5',
		message:
	...
	},
	{
		name: 'クロクマほっと',
		message:
			'すばるちゃん、3周年おめでとうございます！私はすばるちゃんのキレッキレのツッコミやダンス、なにより何をしても可愛らしいすばるちゃんのことが大好きです。これからもいっぱい応援するから、いっぱい楽しいことしようね！本当に本当におめでとう！！！🎉'
	},
	{
		name: '315Seimu',
		message: 'スバルちゃん3周年おめでとう!!! とっっっても素晴らしいアイドルだよー!!!'
	},
	{
		name: 'Country Fields',
		message:
	...
	},
	{
		name: 'ななスタ',
		message:
			'スバルちゃん3周年おめでとう！毎日楽しい配信をしてくれていることにとても感謝しています。もっと早くスバルちゃんを知れたらよかったと思ったりもしますが、そのぶんこれからずっと応援していきます！'
	},
	{
		name: '@matagwe',
		message:
	...
	},
	{
		...
		message:
			'大空スバルへ 一年半前にYouTubeからスバルの切り抜きでそ太陽のような元気な女の子が見つかりました。  スバル色んな面白い企画によって僕はこのホロライブという世界にハマりました。日本のvtuberですから日本語を喋ることは当たり前だけど､スバルは正極的に英語で海外ニキとコミュニケーションを取ることは本当に嬉しかった。  スバルは困難から乗り越える今は本物のアイドルになったことは誰でも思わないだろう。ステージに立つ歌うの姿はマジ誰より眩しかった。  今ここに僕の気持ちを伝えておきます キラキラ輝きのアヒルアイドルに ３週年おめでとうございます!!これからもよろしくお願いします。'
	},
	{
		name: 'SoraTSky',
		message:
			'スバルちゃん、三周年おめでとうヾ(〃^∇^)ﾉ。この三年の間色々あって楽しかったり大変な事もあったけど、何時も頑張ってくれて有難う！三年もずっと推して来て良かったと思ってるし、これからも一番推しだよ。今度は四周年を目指して頑張ってね。応援してるよ(*⌒0⌒)ｂ'
	},
	{
		name: 'すや饅頭[すやマンティス]',
		message:
			'スバルちゃん３周年本当におめでとう！２周年の時は延期になって悲しくてスバルちゃんと一緒に泣いていたのを昨日のように覚えています。そこからいろいろな企業とコラボしたり、オリ曲出したり、ライブに出たり、登録者１００万人突破したりと、とてもワクワクさせていただきました！あっという間だったけどとても濃い充実した１年でした！この先何周年たってもワクワクとドキドキ、元気を届けてください！これからも応援しています！'
	},
	{
		name: 'ziiimaaa11',
		message:
	...
	},
	{
		name: 'ガーガント(ミリアム)',
		message:
			'正直言うとスバルが最推しになるとは思わずホロライブに来た。最初は全員をなんとなくで見てるうちに他の友達から「アヒルのASMR」という理由で見始めてはいたが、今になっては毎日スバルの生配信を見るためにスバルのツイッターやYoutubeページに行ってる。最近自分が辛い思いをしてて立ち直れないんじゃないかって思ってる中ホロライブを見つけ、スバルの元気さによって後押しをされたり、元気付けられたり、笑わせてもらったりしてて感謝しようにもスパチャが送れず、かと言ってどうやって感謝すれば良いのかも分からずこう言う場所で投稿してただ届くといいなと思いながら書いてます。そして何よりも前に進もうと思えました。活発的な所、思った事を直接言える所、ノリが乗りやすい所、95デシベルの声、コラボでのてぇてぇ、皆のために頑張ったり、何から何まで楽しませてもらっており本当にありがとうございます。もっと色々書きたい事があったのですが、上限まで来てしまったので最後に….私が初めて「アイドル」が好きになったのは多分「大空スバル」です。今もこれからもずっと遠くから小さく、でも力強く応援し続けていきます。スバ友フォエバー。'
	},
	{
		name: 'Justin',
	...
	{
		name: '騎士死神',
		message: 'いつも明るく楽しい配信をしてくれてありがとう、これからも応援します！'
	},
	{
		name: '@noazaku22222',
		message:
	...
	},
	{
		name: 'Eclogue',
		message:
			'3年もの間、楽しみとそれに伴う色とりどりの感情をファンやリスナーの皆様に与え続けていただいて、本当に感謝していますし尊敬しております。願わくばスバルさんを応援できるという喜びのある時間がこれから先もずっと続いていきますように。'
	},
	{
		name: 'Orion',
		message:
	...
	},
	{
		name: 'コロイド',
		message:
			'活動3周年おめでとう！いつも楽しい時間をありがとう！これからもスバルちゃんの思うまま突っ走ってけ〜！'
	},
	{
		name: 'Ava',
		message:
	...
	{ name: 'ぐりーん', message: '3周年おめでとうー！！！これからも応援するよ！！' },
	{
		name: 'Cherka Derka',
		message:
	...
	{
		name: 'jack',
		message: 'スバルちゃん3周年おめでとう！これからも輝くスバルちゃんを応援しています！'
	},
	{
	...
	},
	{
		name: 'ぷちぷりん',
		message:
			'スバルちゃん！3周年おめでとうございます🥳いつも元気をもらっています！！最近ファンになったばかりなのですが、スバルちゃんに出会えて毎日幸せを感じています！！これからもスバルちゃんが楽しい日々が過ごせますように……応援しています……！！！大好きです！！！！！'
	},
	{
	...
	},
	{
		name: '若本の自転車',
		message:
			'３周年おめでとうスバルちゃん。デトロイトの配信からスバルちゃんが楽しくストーリーを考察する姿をきっかけに見始めました。いつも面白い放送で笑いと元気をいただいてます。これからも面白い放送を期待しながら応援しています。'
	},
	{
		name: 'じっくりコトコト',
		message:
	...
	},
	{
		name: 'ぽていと',
		message:
			'いつも元気のある配信をしてくれてありがとう！！！本当にいつもスバルちゃんの配信のときの元気や、明るさで元気づけてもらってるよ〜歌ってみたとかでもいつもの配信のときのギャップもあってめちゃめちゃ可愛い！（普段の配信も可愛いけど）今年高校受験で、いつもいつもリアタイできるかわかんないけど、これからもよろしくね〜。すぅ〜〜きー！！！'
	},
	{
		name: 'JayJaySannn',
		message:
	...
	},
	{
		name: 'オーランズ',
		message:
			'毎日とても元気をもらっています、世界で一番大好きです、いつも貴重な時間を割いてくれてありがとう'
	},
	{
		name: '@zearcxm69',
		message:
	...
	{
		name: '@nicole04121523',
		message: 'すばるちゃん、三周年本当におめでとう! これからもずっと応援してるよ! '
	},
	{
		name: 'TheBronyGames',
		message:
	...
	},
	{
		name: 'ぽぽぽドラゴン',
		message:
			'3周年おめでとう！僕がスバルちゃんを知ってからまだ1年も経ってないですがとても嬉しくおもいます'
	},
	{
		name: 'Rabby Lacierda',
		message:
