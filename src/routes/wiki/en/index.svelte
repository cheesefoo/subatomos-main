...
<div class='content p-4 text-sm lg:text-lg lg:p-24'>
	<div class='intro'>
		...
		<blockquote class='lg:text-lg text-justify pl-4 lg:ml-8 lg:pl-8 border-l border-l-salmon'>
	...
	<div class='border text-sm my-8 p-4 lg:pl-16 lg:pr-16 lg:m-16'>
		<WikiSearch />
	...
	<p>Subaru is naturally extroverted, though she will deny it. She is hardworking, and always optimistic, even in bad
		...
		Subaru is regarded as the brightest person in Hololive, a descriptor with multiple meanings. Her bright personality
	...
	<p>Subaru fans often say that she "makes any collab work", owing to her ability to entertain an audience and to bring
	...
	<p>Before entering hololive, Subaru was a "normie" who did not know much about otaku culture. She did not play many
		...
		gacha RPG with a slave-like competitive mode dreaded by players and done out of obligation. Many fans relayed to her
	...
	<p>Subaru's membership streams are typically free-talk streams. These streams tend to be more relaxed and relatively
		intimate. She has previously put her karaoke stream archives behind membership, provided wallpapers and other unique
		contents.</p>
	...
	<p>Subaru's fanbase, named Subatomos (Suba-friends, but call it subatomos), often likes to tease her, in a fashion
		similar to an elementary schoolboy. She interacts with them and is very in-tune with what is happening amongst them.
		She claims that she watches her long-time fans and silently judges them when they interact with other hololive
		members on Twitter.
		For overseas Subatomos, Subaru understands the frustration of being unable to understand what people are saying due
